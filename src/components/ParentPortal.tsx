  ...
  return (
    <div className="space-y-4">
      ...
      <div className="surface-card p-5">
        <h3 className="text-sm font-bold">Completion rate by subject</h3>
      ...
      <div className="surface-card p-5">
        <h3 className="text-sm font-bold">Manage published tasks</h3>
            ...
            >
              <div className="min-w-0">
                ...
                <p className="text-[11px] text-muted-foreground">
                  {t.unit_tag ?? "—"} · {t.xp_reward} XP · {t.is_completed ? "completed" : "open"}
                </p>
              </div>
              <button
