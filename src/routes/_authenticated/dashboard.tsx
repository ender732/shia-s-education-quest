  ...
  head: () => ({
    meta: [
      { title: "My Quest Dashboard — Hudson Cliffs Quest" },
      {
        name: "description",
        content:
          "Track XP, complete P.S./I.S. 187 Math, ELA, Science and Social Studies tasks, and submit AI-graded book reports.",
      },
      { property: "og:title", content: "My Quest Dashboard — Hudson Cliffs Quest" },
      {
        property: "og:description",
        content: "Gamified 5th-grade practice with instant AI feedback on RACECE writing.",
      },
    ],
  }),
  component: Dashboard,
